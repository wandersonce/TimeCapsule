...
function NewMemoryForm() {
 ...
 async function handleCreateMemory(event: FormEvent<HTMLFormElement>){
  ...
  return (
    ...
    <button className='inline-block self-end rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-600' type="submit">Save</button>
  </form>
  )
}
